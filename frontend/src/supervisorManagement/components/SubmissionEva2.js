...
<center>
            <div style={{color:'red',textAlign:'center'}}>{this.state.Nameerror}</div>
              ...
              <center>
                ...
                <div class="w3-card-4 w3-margin w3-white"style={{width:'350px',height:'1000px',float:'left'}} >
...
<div class="w3-card-4 w3-margin w3-white"style={{width:'340px',height:'1000px',float:'left'}} >
