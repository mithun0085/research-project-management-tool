...
function Profile() {
    ...
    return (
        ...
        <h2>{isAdmin ? "": <button class="notification" style={{width:'8%',fontSize:'20px'}}><a href = "/topicDocS"   style={{textDecoration:'none', color:'white'}}>Topic Feedbacks <span class="badge">3</span> </a></button>}</h2>
        <div className="profile_page">
            ...
            <div className="col-right">
                ...
                <div style={{overflowX: "auto"}}>
                    ...
                    <h2>{isAdmin ? <button class="w3-bar-item w3-button w3-light-blue" style={{width:'80%'}}><a href = "/viewMSchems"   style={{textDecoration:'none', color:'white'}}>Edit/Delete Marking Schems</a></button> : ""}</h2>
